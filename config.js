...
module.exports = {
     ...
     */
    botname: process.env.BotName || "Pixel",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 Lightspeed",
    ...
    ownernumber: process.env.Owner_Number || "+233570578965",
    instagramId: process.env.Insta || "wade_lightspeed",

    /**
     * other details and parameters
     */
    author: process.env.Author || "Wade-kun🌚🌙",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://Heis:iamwade@cluster0.vx46q.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
